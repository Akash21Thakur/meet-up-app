...
class SingleChatPageTablet extends StatefulWidget {
  ...
  const SingleChatPageTablet({Key? key, required this.uid, required this.userName}) : super(key: key);
...
class _SingleChatPageTabletState extends State<SingleChatPageTablet> {
  ...
  @override
  void initState() {
    BlocProvider.of<CommunicationCubit>(context).getTextMessages('A');
    super.initState();
  }
  ...
  void _sendTextMessage() {
    BlocProvider.of<CommunicationCubit>(context).sendTextMsg(
        ...
        message: _messageController.text, type: 'B');
  }
}
